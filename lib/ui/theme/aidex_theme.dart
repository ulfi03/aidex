...
final ThemeData mainTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      headlineLarge: TextStyle(color: Colors.white, fontSize: 24.0),
      headlineMedium: TextStyle(color: Colors.white, fontSize: 18.0),
      headlineSmall: TextStyle(color: Colors.white, fontSize: 16.0),
      titleLarge: TextStyle(color: Colors.white, fontSize: 24.0),
      titleMedium: TextStyle(color: Colors.white, fontSize: 20.0),
