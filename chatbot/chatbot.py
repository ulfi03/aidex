...
text = ""
fileNameArray = os.listdir('C:/Users/NWERTHM/Desktop/aidex/chatbot/documents')
for (index, item) in enumerate(fileNameArray):
        text = text + textract.process("C:/Users/NWERTHM/Desktop/aidex/chatbot/documents/" + item, encoding="utf-8")
